 ...
 * @author User
 */
public class User_Store extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton5.setText("Search by Map");
        ...
        jButton6.setText("Your Nearest Stores");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        User_store_list us = new User_store_list();
        us.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(User_Store.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new User_Store().setVisible(true);
            }
        });
    }
